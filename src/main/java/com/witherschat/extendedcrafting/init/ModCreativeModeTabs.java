...
import com.witherschat.extendedcrafting.config.ModFeatureFlags;
...
public final class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> CREATIVE_TAB = REGISTRY.register("creative_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems(FeatureFlagDisplayItemGenerator.create((parameters, output) -> {
                ...
                output.accept(ModBlocks.EPIC_TABLE, ModFeatureFlags.TABLES);
                ...
                output.accept(ModItems.EPIC_CATALYST);
                ...
                output.accept(ModItems.EPIC_COMPONENT);
